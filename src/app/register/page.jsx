...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Password validation rule as indicated in UI design
  ...
  // Handle Google OAuth signup action placeholder
  const handleGoogleSignup = async () => {
    alert('Google signup integration can be linked here.');
  };
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFB] text-[#0F172A] flex flex-col justify-between selection:bg-indigo-600 selection:text-white">
      ...
      {/* Main Register Form Section with increased width */}
        ...
        <div className="max-w-lg w-full bg-white border border-[#E2E8F0] rounded-3xl p-8 sm:p-12 shadow-sm relative overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 px-4 mt-2 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-bold transition-all shadow-sm active:scale-95 flex items-center justify-center gap-2 disabled:opacity-50"
            >
